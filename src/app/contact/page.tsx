    ...
    <div className={isRTL ? "rtl" : "ltr"}>
      <section className="pt-32 pb-16 hero-pattern">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <p className="text-gold-500 text-xs font-semibold uppercase tracking-widest mb-3">Get In Touch</p>
            ...
            <div className={isRTL ? "text-right" : ""}>
              ...
              <div className="space-y-6">
                {[
                  ...
                  <a key={item.label} href={item.href} className={`flex items-start gap-4 group ${isRTL ? "flex-row-reverse" : ""}`}>
                    <div className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-xl shrink-0 group-hover:border-gold-500/30 transition-all">
                      {item.icon}
                    </div>
                    <div>
  ...
  {item.value}
              ...
              <div className="mt-10">
                ...
                <div className="flex gap-3">
                  <a href="#" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/40 hover:border-gold-400 hover:text-gold-400 transition-all">
                  ...
                  <a href="https://wa.me/201122299843" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 bg-green-500/10 border border-green-500/30 text-green-400 rounded-full text-sm hover:bg-green-500/20 transition-all">
            ...
            {/* Form */}
            <div className="bg-navy-800/40 border border-white/10 rounded-2xl p-8">
              <ContactForm />
            </div>
          </div>
        </div>
